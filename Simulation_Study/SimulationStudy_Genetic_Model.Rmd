...
States = c("C","I","L")
settings_cor = settings[jobs_cor,]
...
if(PLOT_RESULTS){
  ...
  for(cardinality in cardinalities){ # cardinalities
    ...
    for(pattern in unique(settings_cor$COI_pattern)){
      JOBS_pattern <- rownames(settings_cor)[settings_cor$COI_pattern == as.character(pattern)]
      ...
      for(relationship in relationships){
        ...
        colnames(X) = settings_cor[JOBS_pattern,'M']
