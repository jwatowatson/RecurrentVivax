...
Prior_params_M0 = list(Hyper_inv_lambda_mean = 900,
                       Hyper_inv_lambda_sd = 50,
                       Hyper_AS_shape_mean = 10,
                       Hyper_AS_shape_sd = 1,
                       Hyper_AS_scale_mean = 21,
                       Hyper_AS_scale_sd = 1,
                       Hyper_CQ_shape_mean = 10,
                       Hyper_CQ_shape_sd = 1,
                       Hyper_CQ_scale_mean = 42,
                       Hyper_CQ_scale_sd = 2,
                       Hyper_logit_mean_p = -1.5,
                       Hyper_logit_sd_p = .5,
                       Hyper_logit_c1_mean = -4.5,
                       Hyper_logit_c1_sd = .25,
                       Hyper_recrud_shape_mean = 8,
                       Hyper_recrud_shape_sd = 1,
                       Hyper_recrud_scale_mean = 14,
                       Hyper_recrud_scale_sd = 1)
# Model 1 has the same parameters with a few extra
Prior_params_M1 = c(Prior_params_M0, 
                    Early_L_logit_mean = 0,
                    Early_L_logit_sd = .25,
                    Hyper_inv_gamma_mean = 50,
                    Hyper_inv_gamma_sd = 10)
...
if(RUN_MODELS){
  ...
  # save(mod0_Fit, file = '../RData/LargeFiles/StanModels_mod0.RData')
  # 
  ...
  #                     iter = IT, warmup = WarmUp,
  #                     chains=Chains, thin = thin)
  # save(mod3_Fit, file = '../RData/LargeFiles/StanModels_mod3.RData')
}
...
traceplot(mod1_Fit, c('inv_lambda','inv_gamma'))
traceplot(mod1_Fit, c('Recrud_shape','Recrud_scale','logit_c1_CQ','logit_c1_AS'))
