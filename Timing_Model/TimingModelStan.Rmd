...
hist(1/thetas_mod1$lambda, main='Mean time to reinfection', xlab='lambda (1/days)')
hist(1/thetas_mod1$gamma, main='Mean time to late reLapse', xlab='gamma (1/days)')
...
traceplot(mod2_Fit, c('gamma','lambda','lambda_recrud'))
...
hist(1/thetas_mod2$lambda, xlab='Mean time to reinfection (days)', main='')
