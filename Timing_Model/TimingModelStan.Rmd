...
hist(1/thetas_mod1$lambda, main='Mean time to reinfection', xlab='days')
...
prob_labels_raw_AS[2,] = 
  ...
  dweibull(Ts , shape = mean(thetas_mod2$AS_shape), scale = mean(thetas_mod2$AS_scale))
# Late Relapse
...
prob_labels_raw_CQ[2,] =
  ...
  exp(mean(thetas_mod2$log_EarlyL))*
  dweibull(Ts , shape = mean(thetas_mod2$CQ_shape), scale = mean(thetas_mod2$CQ_scale))
# Late Relapse
