...
Prior_params_M1 = list(Hyper_lambda_shape = 100,
                       Hyper_lambda_rate = 100*1200,
                       Hyper_gamma_shape = 100,
                       Hyper_gamma_rate = 100*50,
...
Prior_params_M2 = c(Prior_params_M1, 
                    Hyper_logit_mean_pPMQ_mean = logit(0.9),
...
Run with `{r} Chains` parallel chains. This depends on local computing power.
...
traceplot(mod1_Fit, c('lambda','gamma','lambda_recrud','logit_EarlyL'))
traceplot(mod1_Fit, c('logit_c1_CQ','logit_c1_AS','logit_mean_p','logit_sd_p'))

par(mfrow=c(1,2))
thetas_mod1 = extract(mod1_Fit)
hist(thetas_mod1$lambda, main='Mean time to reinfection', xlab='lambda (1/days)')
hist(thetas_mod1$gamma, main='Mean time to late reLapse', xlab='gamma (1/days)')
