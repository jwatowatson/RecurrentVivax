...
data {
  ...
  real<lower=0>   Early_L_logit_mean;     // parameter a1 of beta prior on Early_L
  real<lower=0>   Early_L_logit_sd;       // parameter a2 of beta prior on Early_L
...
Timing_Model2_RE = stan_model(model_code = mod2)