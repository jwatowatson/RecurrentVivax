...
MS_pooled$L_or_C_state_UP = 
  MS_pooled$L_or_C_state_LP = 
  MS_pooled$ClusterID = 
...
ThetasInflated_full_post$ID_True = MS_inflated$ID_True
...
mycols_drugs = brewer.pal(n=3, name = 'Set1') # colors for drugs - consistent with timing model

mycols_states = brewer.pal(6,'Set2') # colors for states - need uncertain ones as well
