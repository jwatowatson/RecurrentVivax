...
x1 =  table(MS_pooled_summary$ID[grep('VHX',MS_pooled$Episode_Identifier)]) # Typed_VHX_epi_count
sum(x1 == 1); x1 = x1[x1>1] # Remove the one "1" from Typed VHX as a mixtake
