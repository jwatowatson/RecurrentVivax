...
RUN_MODELS_SINGLE_SIMPLE = T            # can do on laptop
RUN_MODELS_FULL_POSTERIOR_SIMPLE = T    # can do on laptop
RUN_MODELS_FULL_POSTERIOR_INFLATED = F  # cluster is better
RUN_MODELS_FALSE_POSITIVE = F           # only cluster!!
CREATE_PLOTS = T
...
# Commented next bit out: we need the episodes with no recurent data for allele freq estimation
...
MS_inflated = Inflate_into_pairs(MSdata = MS_inflate)
