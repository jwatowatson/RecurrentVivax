...
```{r CoatneyStylePLot, echo=FALSE, dev="svg"}
if(CREATE_PLOTS){
...
```{r CompleteDataPlot, fig.height=7, fig.width=7, echo=FALSE, dev = 'svg'}
if(CREATE_PLOTS){
  
  par(las=1, mfcol = c(2,1), mar=c(4,4,2,1), bty='n', family = 'serif')
