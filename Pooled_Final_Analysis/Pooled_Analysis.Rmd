...
EXCLUDE_COMPLEX = T # There are XX complex ones that considerably increase computation time

# runs the model for 100 random draws from the Time model posterior on those that can be directly computed
RUN_MODELS_FULL_POSTERIOR = T # can do on laptop (4.5 hours)
...
RUN_MODELS_FULL_POSTERIOR_TAGNOSTIC = T # can do on laptop (20 mins)
...
Ksamples_min = 100 # set this to low (~5) to run pilot analysis. Should be 100 in full analysis
...
if(RUN_MODELS_FULL_POSTERIOR){
  ...
  save(thetas_9MS, file = '../RData/GeneticModel/Full_Posterior_Model_samples.RData')
  toc()
} else {
...
if(RUN_MODELS_FULL_POSTERIOR_TAGNOSTIC){
  ...
  save(thetas_9MS_Tagnostic, file = '../RData/GeneticModel/Full_Posterior_Model_samples_Tagnostic.RData')
  toc()
} else {
